...
Source0  : https://github.com/home-assistant/home-assistant/archive/2021.7.4/home-assistant-2021.7.4.tar.gz
...
%prep
%setup -q -n core-2021.7.4
cd %{_builddir}/core-2021.7.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627049723
...
cp %{_builddir}/core-2021.7.4/LICENSE.md %{buildroot}/usr/share/package-licenses/home-assistant/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
