...
Source0  : https://github.com/home-assistant/home-assistant/archive/2021.1.0/home-assistant-2021.1.0.tar.gz
...
%prep
%setup -q -n core-2021.1.0
cd %{_builddir}/core-2021.1.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609959001
...
cp %{_builddir}/core-2021.1.0/LICENSE.md %{buildroot}/usr/share/package-licenses/home-assistant/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
