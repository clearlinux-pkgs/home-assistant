...
Source0  : https://github.com/home-assistant/home-assistant/archive/2022.2.7/home-assistant-2022.2.7.tar.gz
...
%prep
%setup -q -n core-2022.2.7
cd %{_builddir}/core-2022.2.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645039604
...
cp %{_builddir}/core-2022.2.7/LICENSE.md %{buildroot}/usr/share/package-licenses/home-assistant/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
