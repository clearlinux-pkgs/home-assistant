...
%prep
%setup -q -n core-2021.12.8
cd %{_builddir}/core-2021.12.8
%patch1 -p1
...
cp %{_builddir}/core-2021.12.8/LICENSE.md %{buildroot}/usr/share/package-licenses/home-assistant/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
