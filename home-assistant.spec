...
Version  : 0.108.0
Release  : 154
URL      : https://github.com/home-assistant/home-assistant/archive/0.108.0/home-assistant-0.108.0.tar.gz
Source0  : https://github.com/home-assistant/home-assistant/archive/0.108.0/home-assistant-0.108.0.tar.gz
...
%prep
%setup -q -n core-0.108.0
cd %{_builddir}/core-0.108.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586368300
...
cp %{_builddir}/core-0.108.0/LICENSE.md %{buildroot}/usr/share/package-licenses/home-assistant/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
