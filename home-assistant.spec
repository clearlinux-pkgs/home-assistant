...
Version  : 0.113.1
Release  : 189
URL      : https://github.com/home-assistant/home-assistant/archive/0.113.1/home-assistant-0.113.1.tar.gz
Source0  : https://github.com/home-assistant/home-assistant/archive/0.113.1/home-assistant-0.113.1.tar.gz
...
%prep
%setup -q -n core-0.113.1
cd %{_builddir}/core-0.113.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595864678
...
cp %{_builddir}/core-0.113.1/LICENSE.md %{buildroot}/usr/share/package-licenses/home-assistant/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
