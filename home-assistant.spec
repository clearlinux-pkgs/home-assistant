...
Source0  : https://github.com/home-assistant/home-assistant/archive/2021.6.2/home-assistant-2021.6.2.tar.gz
...
%prep
%setup -q -n core-2021.6.2
cd %{_builddir}/core-2021.6.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622849036
...
cp %{_builddir}/core-2021.6.2/LICENSE.md %{buildroot}/usr/share/package-licenses/home-assistant/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
