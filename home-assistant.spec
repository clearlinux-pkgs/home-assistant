...
Source0  : https://github.com/home-assistant/home-assistant/archive/0.118.4/home-assistant-0.118.4.tar.gz
...
%prep
%setup -q -n core-0.118.4
cd %{_builddir}/core-0.118.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1606585878
...
cp %{_builddir}/core-0.118.4/LICENSE.md %{buildroot}/usr/share/package-licenses/home-assistant/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
