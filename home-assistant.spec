...
%prep
%setup -q -n core-2022.6.1
cd %{_builddir}/core-2022.6.1
pushd ..
cp -a core-2022.6.1 buildavx2
popd
...
cp %{_builddir}/core-2022.6.1/LICENSE.md %{buildroot}/usr/share/package-licenses/home-assistant/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
