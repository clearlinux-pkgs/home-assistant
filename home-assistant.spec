...
%prep
%setup -q -n core-2021.7.3
cd %{_builddir}/core-2021.7.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626445773
...
cp %{_builddir}/core-2021.7.3/LICENSE.md %{buildroot}/usr/share/package-licenses/home-assistant/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
