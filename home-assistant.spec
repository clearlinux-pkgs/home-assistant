...
Source0  : https://github.com/home-assistant/home-assistant/archive/0.109.3/home-assistant-0.109.3.tar.gz
...
%prep
%setup -q -n core-0.109.3
cd %{_builddir}/core-0.109.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588608829
...
cp %{_builddir}/core-0.109.3/LICENSE.md %{buildroot}/usr/share/package-licenses/home-assistant/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
