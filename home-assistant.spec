...
Source0  : https://github.com/home-assistant/home-assistant/archive/2022.3.0/home-assistant-2022.3.0.tar.gz
...
%prep
%setup -q -n core-2022.3.0
cd %{_builddir}/core-2022.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646328214
...
cp %{_builddir}/core-2022.3.0/LICENSE.md %{buildroot}/usr/share/package-licenses/home-assistant/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
