...
Source0  : https://github.com/home-assistant/home-assistant/archive/0.102.0/home-assistant-0.102.0.tar.gz
...
%prep
%setup -q -n home-assistant-0.102.0
cd %{_builddir}/home-assistant-0.102.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574347626
...
cp %{_builddir}/home-assistant-0.102.0/LICENSE.md %{buildroot}/usr/share/package-licenses/home-assistant/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
