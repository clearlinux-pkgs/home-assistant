...
Source0  : https://github.com/home-assistant/home-assistant/archive/2021.10.1/home-assistant-2021.10.1.tar.gz
...
%prep
%setup -q -n core-2021.10.1
cd %{_builddir}/core-2021.10.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633715761
...
cp %{_builddir}/core-2021.10.1/LICENSE.md %{buildroot}/usr/share/package-licenses/home-assistant/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
