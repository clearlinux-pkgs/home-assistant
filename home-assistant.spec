...
%prep
%setup -q -n core-0.117.0
cd %{_builddir}/core-0.117.0
...
cp %{_builddir}/core-0.117.0/LICENSE.md %{buildroot}/usr/share/package-licenses/home-assistant/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
