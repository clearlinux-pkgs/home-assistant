...
%prep
%setup -q -n core-2022.2.9
cd %{_builddir}/core-2022.2.9
...
cp %{_builddir}/core-2022.2.9/LICENSE.md %{buildroot}/usr/share/package-licenses/home-assistant/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
