...
Source0  : https://github.com/home-assistant/home-assistant/archive/2022.6.3/home-assistant-2022.6.3.tar.gz
...
%prep
%setup -q -n core-2022.6.3
cd %{_builddir}/core-2022.6.3
pushd ..
cp -a core-2022.6.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654610493
...
cp %{_builddir}/core-2022.6.3/LICENSE.md %{buildroot}/usr/share/package-licenses/home-assistant/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
