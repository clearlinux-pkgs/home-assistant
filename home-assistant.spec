...
%prep
%setup -q -n home-assistant-0.103.6
cd %{_builddir}/home-assistant-0.103.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578415042
...
cp %{_builddir}/home-assistant-0.103.6/LICENSE.md %{buildroot}/usr/share/package-licenses/home-assistant/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
