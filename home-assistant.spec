...
Source0  : https://github.com/home-assistant/home-assistant/archive/0.104.3/home-assistant-0.104.3.tar.gz
...
%prep
%setup -q -n home-assistant-0.104.3
cd %{_builddir}/home-assistant-0.104.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579624739
...
cp %{_builddir}/home-assistant-0.104.3/LICENSE.md %{buildroot}/usr/share/package-licenses/home-assistant/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
