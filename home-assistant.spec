...
Source0  : https://github.com/home-assistant/home-assistant/archive/0.106.6/home-assistant-0.106.6.tar.gz
...
%prep
%setup -q -n core-0.106.6
cd %{_builddir}/core-0.106.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583884694
...
cp %{_builddir}/core-0.106.6/LICENSE.md %{buildroot}/usr/share/package-licenses/home-assistant/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
