...
%prep
%setup -q -n core-2021.6.6
cd %{_builddir}/core-2021.6.6
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624289771
...
cp %{_builddir}/core-2021.6.6/LICENSE.md %{buildroot}/usr/share/package-licenses/home-assistant/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
