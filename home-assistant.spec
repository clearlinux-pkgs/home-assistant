...
Version  : 0.108.1
Release  : 155
URL      : https://github.com/home-assistant/home-assistant/archive/0.108.1/home-assistant-0.108.1.tar.gz
Source0  : https://github.com/home-assistant/home-assistant/archive/0.108.1/home-assistant-0.108.1.tar.gz
...
%prep
%setup -q -n core-0.108.1
cd %{_builddir}/core-0.108.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586445942
...
cp %{_builddir}/core-0.108.1/LICENSE.md %{buildroot}/usr/share/package-licenses/home-assistant/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
